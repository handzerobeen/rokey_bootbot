...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'panic_move_home_node = bootbot.panic_move_home_node:main',

            'trigger_node = bootbot.trigger_node:main',

            'mock_robot_write_node = bootbot.mock_robot_write_node:main',

            # 테스트
            'test_json_server_node = bootbot.test_json_server_node:main',
            'server_connector_node_test = '
            'bootbot.server_connector_node_test:main',
            ...
            'bootbot.server_connector_node_designing:main',
